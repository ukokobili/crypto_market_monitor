...
resource "aws_security_group" "crypto_security_group" {
  name        = "crypto_security_group"
...
resource "aws_instance" "crypto_ec2" {
  ...
  security_groups = [aws_security_group.crypto_security_group.name]
  tags = {
    Name = "crypto_ec2"
  }
...
cd /home/ubuntu && git clone https://github.com/ukokobili/crypto_market_monitor
...
resource "aws_budgets_budget" "ec2" {
  ...
  time_period_start = "2024-04-17_00:00"
  time_unit         = "MONTHLY"
