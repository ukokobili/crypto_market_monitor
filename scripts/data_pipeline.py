...
def run_pipeline() -> None:
    try:
        ...
        logger.info(
            f"Pipeline execution time: {pipeline_execution_time} seconds"
        )
        ...
        for job_name in ['extract', 'transform', 'load']:
            ...
            logger.info(
                f"Time for {job_name} job: {job_execution_time} seconds"
            )
        ...
        logger.info(
            f"Average pipeline execution time: {average_execution_time} seconds"
        )
